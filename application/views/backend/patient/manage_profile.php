	...
	<div class="col-sm-7">
		<div class="panel panel-info">
			...
			<div class="panel-body table-responsive">
				...
				<?php echo form_open(base_url(). 'patient/manage_profile/update', array('class' => 'form-horizontal form-groups-bordered', 'enctype'=> 'multipart/form-data'));?>
				...
				<div class="form-group"> 
					 <label class="col-sm-12"><?php echo get_phrase('patient Image');?>*</label>        
					 <div class="col-sm-12">
...
<?php echo form_open(base_url() . 'patient/manage_profile/change_password', array('class' => 'form-horizontal form-groups-bordered validate', 'target' => '_top', 'enctype' => 'multipart/form-data'));
        ?>			
					<div class="form-group">
